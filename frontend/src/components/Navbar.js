        ...
        <nav className="bg-[#0b0338] p-4">
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="hidden md:flex">
                    <a href="#" className="text-white mx-4 hover:text-navHover">Browse</a>
                    <a href="#" className="text-white mx-4 hover:text-navHover">Community</a>
                    <a href="#" className="text-white mx-4 hover:text-navHover">Write</a>
                    <a href="#" className="text-white mx-4 hover:text-navHover">Login</a>
                </div>
            ...
            <div className={`md:hidden fixed inset-y-0 right-0 bg-[#0b0338] w-48 lg:w-96 transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-500 ease-in-out`}>
